...
public class ByteReader {
    ...
    /**
     * Method for reading n consecutive floats, returned in a new array from IMU data (int16).
     *
     * @param size Number of bytes to be read (usually 10)
     * @return A new array with read bytes
     */
    public float[] getBytesIMU(int size) {
        float[] result = new float[size];
        byte temp0;
        byte temp1;
        for (int i = 0; i < size; ++i) {
