...
public abstract class Sensor {
    ...
    public String getStatusString() {
        ...
        if (isConnected()) {
            status += " <b><font color = '#006400'>Connected.</font></b><br>";
        } else {
            status += " <b><font color = 'red'>Disconnected.</font></b><br>";
        }
        if (areCharFound()) {
            status += " Characteristics are currently: <b><font color = '#006400'>Found.</font></b><br>";
        } else {
            status += " Characteristics are currently: <b><font color = 'red'>Not found.</font></b><br>";
        }
        if (isMeasuring())
     ...
     */
    public abstract void startMeasurement(boolean isSession, String fileName);
    ...
    /**
     * Method to start data logging.
     */
    public abstract void startLogging(String name);
    ...
    /**
     * Method for check if sensor is streaming raw data for a session.
     *
     * @return True if sensor is streaming, and doing a session.
     */
    ...
    public abstract void foundChar(boolean b);

    public abstract boolean areCharFound();
